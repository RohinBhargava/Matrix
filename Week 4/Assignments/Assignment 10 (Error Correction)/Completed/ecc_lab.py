...
def find_error(e):
    ...
    """
    return Vec(H.D[1], {col : one for col in mat2coldict(H) if vec.equal(mat2coldict(H)[col], e)} )
...
def find_error_matrix(S):
    ...
    """
    return coldict2mat({col : find_error(value) for col,value in mat2coldict(S).items()})

## Task 6
s = "I'm trying to free your mind, Neo. But I can only show you the door. You’re the one that has to walk through it."
P =  bits2mat(str2bits(s[i] for i in range(len(s))))
