...
def rotation(angle):
    ...
    '''
    return Mat(({'x', 'y', 'u'}, {'x', 'y', 'u'}), { ('x','x') : math.cos(angle), ('x','y') : -math.sin(angle), ('y','y') : math.cos(angle), ('y','x') : math.sin(angle), ('u','u') : 1 })
## Task 5
...
def grayscale():
    ...
    '''
    return Mat(({'r', 'g', 'b'}, {'r', 'g', 'b'}), { ('r','r') : 77.0/256, ('r','g') : 151.0/256, ('r','b') : 28.0/256, ('g','r') : 77.0/256, ('g','g') : 151.0/256, ('g','b') : 28.0/256, ('b','r') : 77.0/256, ('b','g') : 151.0/256, ('b','b') : 28.0/256 })   
...
def reflect_about(p1,p2):
    ...
    '''
    return rotation_about(p2, math.atan2((p1[0] - p2[0])/(p1[1] -p1[1]) if p1[1] != p2[1] else 0)) * reflect_x() * rotation_about(-p2, -math.atan2((p1[0] - p2[0])/(p1[1] -p1[1])) if p1[1] != p2[1] else 0)
