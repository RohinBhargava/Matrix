...
def subset_basis(vlist):
    ...
    '''
    return [vlist[i] for i in range(len(vlist)) if orthogonalize(vlist)[i] * orthogonalize(vlist)[i] > 10E-20]
...
x_hat_1 = list2vec([1.0832236842105263, 0.9838815789473685])
...
x_hat_2 = list2vec([2.501098838207519, 2.658959537572254])
